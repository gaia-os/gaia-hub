...
class AgentInterface(ABC):
    ...
    def to_sample_site(self, obs_name):
        """
        Getter
        :param obs_name: the name of the observation in the ontology
        :return: the model's sample site corresponding to the observation name
        """
        ...
    ...
    def get_report_by_sample_site(self):
        ...
        :return: a python dictionary whose keys are sample site names and values are report data (observations) for
        those sites
        """
        return {
    ...
    def inference_algorithm(self, kernel=None, **kwargs):
        ...
        if kernel is None and self.guide is None:
    ...
    def efe(self, samples, present_time):
        ...
        """
        return self.expected_free_energy(samples, present_time, ["sr"])
